...
class HealthKitManager {
    ...
    static let types: [String: TypeInfo] = [
        ...
        HKQuantityTypeIdentifierDietaryCarbohydrates: TypeInfo(identifier: HKQuantityTypeIdentifierDietaryCarbohydrates, shortDescription: "Carbohydrates", unit: HKUnit.gramUnit()),
        ...
        HKQuantityTypeIdentifierDietaryEnergyConsumed: TypeInfo(identifier: HKQuantityTypeIdentifierDietaryEnergyConsumed, shortDescription: "Dietary Calories", unit: HKUnit.kilocalorieUnit()),
        ...
        HKQuantityTypeIdentifierDietaryFiber: TypeInfo(identifier: HKQuantityTypeIdentifierDietaryFiber, shortDescription: "Fibre", unit: HKUnit.gramUnit()),
        ...
        HKQuantityTypeIdentifierDietaryFatMonounsaturated: TypeInfo(identifier: HKQuantityTypeIdentifierDietaryFatMonounsaturated, shortDescription: "Monounsaturated Fat", unit: HKUnit.gramUnit()),
        ...
        HKQuantityTypeIdentifierDietaryFatPolyunsaturated: TypeInfo(identifier: HKQuantityTypeIdentifierDietaryFatPolyunsaturated, shortDescription: "Polyunsaturated Fat", unit: HKUnit.gramUnit()),
        ...
        HKQuantityTypeIdentifierDietaryProtein: TypeInfo(identifier: HKQuantityTypeIdentifierDietaryProtein, shortDescription: "Protein", unit: HKUnit.gramUnit()),
        ...
        HKQuantityTypeIdentifierDietaryFatSaturated: TypeInfo(identifier: HKQuantityTypeIdentifierDietaryFatSaturated, shortDescription: "Saturated Fat", unit: HKUnit.gramUnit()),
        ...
        HKQuantityTypeIdentifierDietarySodium: TypeInfo(identifier: HKQuantityTypeIdentifierDietarySodium, shortDescription: "Sodium", unit: HKUnit.gramUnitWithMetricPrefix(HKMetricPrefix.Milli)),
        ...
        HKQuantityTypeIdentifierDietaryFatTotal: TypeInfo(identifier: HKQuantityTypeIdentifierDietaryFatTotal, shortDescription: "Total Fat", unit: HKUnit.gramUnit()),
