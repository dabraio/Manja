...
class MealListTableViewController: UITableViewController {
    ...
    func loadSampleMeals() {
        meals.append(Category(name: "Bebidas", meals: [
            Meal(name: "Garrafa de Água", facts: [Meal.Fact(typeIdentifier: "HKQuantityTypeIdentifierDietaryWater", value: 1)], referenceServing: 1, serving: 750)!,
            ...
            Meal(name: "Café", facts: [Meal.Fact(typeIdentifier: "HKQuantityTypeIdentifierDietaryCaffeine", value: 60), Meal.Fact(typeIdentifier: "HKQuantityTypeIdentifierDietaryWater", value: 40)], referenceServing: 1, serving: 1)!,
            Meal(name: "Descafeinado", facts: [Meal.Fact(typeIdentifier: "HKQuantityTypeIdentifierDietaryCaffeine", value: 5), Meal.Fact(typeIdentifier: "HKQuantityTypeIdentifierDietaryWater", value: 40)], referenceServing: 1, serving: 1)!,
    ...
    @IBAction func unwindToMealList(sender: UIStoryboardSegue) {
        if let sourceViewController = sender.sourceViewController as? MealTableViewController, meal = sourceViewController.meal {
            ...
            case .New:
                ...
                meals.append(Category(name: "New Category", meals: [meal]))
